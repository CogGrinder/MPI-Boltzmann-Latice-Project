...
**/ //TODO: what does the communication need to know? Why is this important?
typedef struct lbm_comm_t_s
{
	...
	**/
	int x; //TODO is x a current value of the process? Do we need to know?
	/** 
	...
	**/
	...
	MPI_Datatype type;
	/** Can be used to keep track of buffer for non contiguous communications. **/ //TODO what is buffer_send_up?
